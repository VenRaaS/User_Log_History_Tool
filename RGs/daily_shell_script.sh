...
#執行-f,並傳進設定好的日期變數
hive -f 使用者瀏覽歷程/gohappy/RGs_table_gen.sql -hiveconf YEAR=$(date +"%Y" --date="1 days ago") -hiveconf MONTH=$(date +"%m" --date="1 days ago") -hiveconf DATE=$(date +"%d" --date="1 days ago");     
